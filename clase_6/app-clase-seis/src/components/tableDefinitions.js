    ...
    dataTabla: [
      {
        numero: "1",
        nombre: "Algarrobo",  
        imagen: "https://www.diarioeltiempo.com.ar/contenido/noticias/original/procesadas/1582899216_1_2018-24-principal.jpg",
        stock:true
      },
      {
        numero: "2",
        nombre: "Molle",
        imagen: "http://churqui.org/img/photos/Mayten%20000.jpg",
        stock:true,
      },
      {
        numero: "3",
        nombre: "Aguaribay",
        imagen: "http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcR-824FiPTZGZegLHcMAEW58jTABGiOzp3DaT6qgO2loKb-aAbkOa6iWq8QB2g5IGVjcpgcnfDga9ZSA_Kb-nihCmNwLexTUmsqNMY8hmT5",
        stock:true
      },
      {
        numero:"4",
        nombre: "Peje",
        imagen: "https://lagranjadecapilladelmonte.files.wordpress.com/2011/08/sombra-de-toro-1.jpg?w=225&h=300",
        stock:false
      },
      {
        numero:"5",
        nombre: "Álamo",
        imagen: "https://www.jardineriaon.com/wp-content/uploads/2014/11/populus-nigra-italica-1024x759.jpg.webp",
        stock:false
      },
    ],
  },
